...
//JRT TOKEN FETCHING
export const fetchJrtContract = (signerOrProvider) =>
  new ethers.Contract(JrtTokenAddress, JrtTokenABI, signerOrProvider);

//CONNECTING With BOO TOKEN CONTRACT
export const connectingWithJrtToken = async () => {
  try {
...
//CONNECTING With FIL TOKEN CONTRACT
